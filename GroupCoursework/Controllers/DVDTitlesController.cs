...
namespace GroupCoursework.Controllers
{
    public class DVDTitlesController : Controller
    {
        ...
        {
            var databaseContext = _context.DVDTitles.Include(d => d.Category).Include(d => d.Produce).Include(d => d.Studio);
        ...
        public async Task<IActionResult> Create([Bind("DVDNumber,DvdTitle,ProduceNumber,CategoryNumber,StudioNumber,DateReleased,StandardCharge,PenaltyCharge")] DVDTitle dVDTitle)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("DVDNumber,DvdTitle,ProduceNumber,CategoryNumber,StudioNumber,DateReleased,StandardCharge,PenaltyCharge")] DVDTitle dVDTitle)
        {
