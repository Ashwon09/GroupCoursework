...
namespace GroupCoursework.Controllers
{
    public class DVDCategoriesController : Controller
    {
        ...
        {
            return View(await _context.DVDCategorys.ToListAsync());
        }
        ...
        public async Task<IActionResult> Details(int? id)
        {
            ...
            var dVDCategory = await _context.DVDCategorys
        ...
        public async Task<IActionResult> Edit(int? id)
        {
            ...
            var dVDCategory = await _context.DVDCategorys.FindAsync(id);
            if (dVDCategory == null)
            {
                return NotFound();
            }
        ...
        {
            var dVDCategory = await _context.DVDCategorys.FindAsync(id);
            _context.DVDCategorys.Remove(dVDCategory);
            await _context.SaveChangesAsync();
            return RedirectToAction(nameof(Index));
        }
        ...
        {
            return _context.DVDCategorys.Any(e => e.CategoryNumber == id);
        }
    }
}
